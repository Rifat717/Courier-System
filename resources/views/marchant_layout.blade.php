				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							<li class="nav-item">
								<a class="nav-link active" aria-current="page" href="{{ url('marchant') }}">Dashboard</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="{{ url('marchantparcel') }}">Parcel</a>
							</li>
							<li class="nav-item">
						...
						<div class="dropdown text-end">
							...
							<ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
								...
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="{{ url('/marchant-logout') }}">Sign out</a></li>
							</ul>
						</div>
					</div>
				</div>
			</nav>
			@yield('marchant_content')
		</div>
