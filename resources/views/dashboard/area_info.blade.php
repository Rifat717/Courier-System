...
<div class="page-heading">
	...
	<section class="section">
		<div class="card">
			...
			<div class="card-body">
				<table class="table table-striped" id="area-info">
					<thead>
						<tr>
							<th>ID</th>
							<th>Area Name</th>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								class="form-control form-control-lg" name="area_name" id="area_name" required>
							</div>
						</div>
						<div class="col-md-6">
							<label>Status: </label>
...
<script type="text/javascript">
	...
	var table1 = $('#area-info').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('all.AreaInfo') }}",
        columns: [
            {data: 'id', name: 'id'},
...
//Edit Data Show By Ajax
    function editAreaInfoData(id) {
        save_method = "edit";
        $('input[name_method]').val('PATCH');
        $('#modal-form form')[0].reset();

        $.ajax({
            url: "{{ url('areainfo') }}" + '/' + id + '/edit',
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                $('#modal-form').modal('show');
                $('.modal-title').text(data.area_name + ' ' + 'Edit Information');
   ...
   function showAreaInfoData(id){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#add-post').hide();
                $('#id').val(data.id);
                $('#area_name').val(data.area_name).prop('readonly', true);
    ...
    //Dalete Data By Ajax
    function deleteAreaInfoData(id) {
